...
Tuttavia, l'analisi qualitativa degli errori, supportata dalla Matrice di Confusione (Figura \ref{fig:bertweet_confusion_matrix}), ha rivelato che la maggior parte delle misclassificazioni residue non è casuale, ma si concentra su specifiche coppie di emozioni semanticamente vicine o contestualmente ambigue:
