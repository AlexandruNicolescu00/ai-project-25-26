...
\begin{enumerate}
    \item \textbf{One Shot}: ciascun campione è accompagnato da un singolo esempio che mostra l’applicazione del task.

    \item \textbf{Three Shot}: ciascun campione è corredato da tre esempi illustrativi dell’applicazione del task.

    \item \textbf{Five Shot}: ciascun campione include cinque esempi che dimostrano l’esecuzione del task.
\end{enumerate}
...
\subsubsection*{One-Shot Performance}
...
\subsubsection*{Three-Shot Performance}
...
\subsubsection*{Five-Shot Performance}
